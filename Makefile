# This Makefile is for the SWF::Analysis extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/SWF/Analysis.pm]
#     AUTHOR => [q[Yuto Abe<yu_abe@localdomain>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[SWF::Analysis]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/SWF/Analysis.pm]
...
MAKE = make
FULLEXT = SWF/Analysis
BASEEXT = Analysis
PARENT_NAME = SWF
DLBASE = $(BASEEXT)
VERSION_FROM = lib/SWF/Analysis.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/SWF/Analysis.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/SWF
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/SWF
...
TO_INST_PM = lib/SWF/Analysis.pm \
	lib/SWF/Analysis/Body.pm \
	lib/SWF/Analysis/Header.pm \
	lib/SWF/Analysis/Reader.pm

PM_TO_BLIB = lib/SWF/Analysis.pm \
	blib/lib/SWF/Analysis.pm \
	lib/SWF/Analysis/Reader.pm \
	blib/lib/SWF/Analysis/Reader.pm \
	lib/SWF/Analysis/Body.pm \
	blib/lib/SWF/Analysis/Body.pm \
	lib/SWF/Analysis/Header.pm \
	blib/lib/SWF/Analysis/Header.pm
...
DISTNAME = SWF-Analysis
DISTVNAME = SWF-Analysis-0.02
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/SWF/Analysis.pm $(INST_MAN3DIR)/SWF::Analysis.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Analysis to SWF</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Yuto Abe&lt;yu_abe@localdomain&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/SWF/Analysis.pm blib/lib/SWF/Analysis.pm \
	  lib/SWF/Analysis/Reader.pm blib/lib/SWF/Analysis/Reader.pm \
	  lib/SWF/Analysis/Body.pm blib/lib/SWF/Analysis/Body.pm \
	  lib/SWF/Analysis/Header.pm blib/lib/SWF/Analysis/Header.pm 
